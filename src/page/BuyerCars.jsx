...
//     const amount = parseFloat(car.Price) * 100; // in paise
//     const buyerEmail = localStorage.getItem("userEmail");
...
//       const sellerRef = doc(db, "seller_registration", car.sellerId);
//       const sellerSnap = await getDoc(sellerRef);
//       if (!sellerSnap.exists()) {
//         alert("Seller not found.");
//         return;
...
//           try {
//             await addDoc(collection(db, "buyer_orders"), orderData);
