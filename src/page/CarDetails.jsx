...
import { useLocation, useNavigate } from 'react-router-dom';
import { Container, Grid, Typography, Card, CardMedia, CardContent, Button, Box, Dialog, DialogTitle, DialogContent, DialogActions } from "@mui/material";
...
function CarDetails() {
  ...
  return (
    <Container sx={{ mt: 10 }}>
      ...
      {/* Inquiry Dialog */}
      <Dialog open={openInquiry} onClose={handleInquiryClose}>
        <DialogTitle>Inquiry About {data.Brand} {data.VehicleModel}</DialogTitle>
        <DialogContent>
          <Box sx={{ mt: 2 }}>
            <Typography><strong>Email:</strong> sales@example.com</Typography>
            <Typography><strong>Phone:</strong> +1 (555) 123-4567</Typography>
            <Typography><strong>Name:</strong> lav prajapati</Typography>
          </Box>
        </DialogContent>
        <DialogActions>
          <Button onClick={handleInquiryClose} color="primary">
            Close
          </Button>
        </DialogActions>
      </Dialog>
